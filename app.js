...
function init() {
	// referências obrigatórias (se faltar, mostra um aviso simples)
	...
	for (const id of required) {
		if (!$(id)) {
			const msg = `Não consegui iniciar (elemento faltando: #${id}). Atualize a página.`;
			const p = $('authError');
